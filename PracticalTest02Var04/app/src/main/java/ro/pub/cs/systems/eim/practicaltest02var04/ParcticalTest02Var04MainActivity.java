...
public class ParcticalTest02Var04MainActivity extends AppCompatActivity {
    ...
    private class ConnectButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            clientPort = Integer.parseInt(serverPort);
    ...
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            clientThread = new ClientThread(
                    "localhost", clientPort, clientAddress, "none", weatherForecastTextView
            );
            clientThread.start();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parctical_test02_var04_main);
